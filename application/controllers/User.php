...
class User extends CI_Controller {
    ...
    public function editProfile()
    {
        ...
        if ( $this->form_validation->run() == FALSE ) {
            ...
            $upload_image = $_FILES['image']['name']; // <- name diambil dari nama image nya 
    ...
    public function changePassword()
    {
        ...
        $this->form_validation->set_rules('new_password2', 'Repeat New Password', 'required|trim|min_length[4]|matches[new_password1]');
        ...
        if ( $this->form_validation->run() == FALSE ) {
            ...
            // Cek apakah current password sama atau tidak dengan password yang sudah ter enkrip di db
            if ( !password_verify($current_password, $data['user']['password'])) {
                ...
                if ( $current_password == $new_password ) {
                    ...
                    // Password benar tidak sama dengan current password
